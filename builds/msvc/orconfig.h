...
/* Define to 1 if you have `environ' already declared. */
...
// HACK: this must be defined or compile will fail on total_bytes_allocated_in_chunks undefined.
#define ENABLE_BUF_FREELISTS
